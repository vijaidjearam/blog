...
4. Launch the "ODBC Data Source (64 bit)" from Windows startmenu
5. click add and in the Create New Data Source select the MariDB ODBC 3.1 Driver and click on Finish button
